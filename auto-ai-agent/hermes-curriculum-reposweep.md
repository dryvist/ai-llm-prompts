---
type: LLM Prompt
title: Hermes curriculum repository sweep
description: Read-only GitHub triage curriculum job.
resource: prompt://dryvist/auto-ai-agent/hermes-curriculum-reposweep
...
source_history:
  - repository: dryvist/ansible-proxmox-ai
    path: roles/hermes_agent/files/curriculum/jobs/reposweep.md
