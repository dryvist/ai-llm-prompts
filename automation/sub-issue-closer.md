---
type: LLM Prompt
title: Sub-Issue Closer
description: Recursively closes parent issues after every tracked sub-issue is complete.
resource: prompt://dryvist/automation/sub-issue-closer
tags: [automation, github, issues, retired-gh-aw]
...
source_history:
  - repository: dryvist/tofu-aws
    path: .github/workflows/sub-issue-closer.md
