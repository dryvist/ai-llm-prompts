---
type: LLM Prompt
title: Hermes curriculum application fleet health
description: Fleet-health and repository cross-reference curriculum job.
resource: prompt://dryvist/auto-ai-agent/hermes-curriculum-apps
tags: [hermes, curriculum, autonomous-agent]
...
source_history:
  - repository: dryvist/ansible-proxmox-ai
    path: roles/hermes_agent/files/curriculum/jobs/apps.md
