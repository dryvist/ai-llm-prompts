---
type: LLM Prompt
title: Daily Malicious Code Scan
description: Reviews recent code changes for malicious behavior and supply-chain compromise indicators.
resource: prompt://dryvist/automation/daily-malicious-code-scan
tags: [automation, github, retired-gh-aw, security]
...
source_history:
  - repository: dryvist/tofu-aws
    path: .github/workflows/daily-malicious-code-scan.md
